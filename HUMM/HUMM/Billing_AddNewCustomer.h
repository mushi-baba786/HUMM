...
namespace HUMM {
	...
	/// <summary>
	/// Summary for Billing_AddNewCustomer
	/// </summary>
	public ref class Billing_AddNewCustomer : public System::Windows::Forms::Form
	{
	public:
		Billing_AddNewCustomer(void)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^  resources = (gcnew System::ComponentModel::ComponentResourceManager(Billing_AddNewCustomer::typeid));
			...
			// textBox5
			// 
			this->textBox5->Location = System::Drawing::Point(144, 189);
			...
			// textBox4
			// 
			this->textBox4->Location = System::Drawing::Point(144, 138);
			...
			// textBox3
			// 
			this->textBox3->Location = System::Drawing::Point(144, 87);
			...
			// textBox2
			// 
			this->textBox2->Location = System::Drawing::Point(144, 36);
			...
			this->label12->Location = System::Drawing::Point(64, 185);
			...
			this->label11->Location = System::Drawing::Point(13, 134);
			this->label11->Name = L"label11";
			this->label11->Size = System::Drawing::Size(112, 23);
			...
			this->button1->Location = System::Drawing::Point(47, 231);
			...
			this->button1->Click += gcnew System::EventHandler(this, &Billing_AddNewCustomer::button1_Click);
			// 
			// button2
			// 
			...
			this->button2->Location = System::Drawing::Point(190, 231);
			...
			this->button2->Click += gcnew System::EventHandler(this, &Billing_AddNewCustomer::button2_Click);
			// 
			// Billing_AddNewCustomer
			// 
			...
			this->Name = L"Billing_AddNewCustomer";
			this->Text = L"Add New Customer";
			this->Load += gcnew System::EventHandler(this, &Billing_AddNewCustomer::Billing_AddNewCustomer_Load);
...
private: System::Void Billing_AddNewCustomer_Load(System::Object^  sender, System::EventArgs^  e) {
}
